...
{
 init_readconfig();
  mpfr_set_d(a_main, 0.123456789012, MPFR_RNDZ);
  mpfr_set_d(b_main, 1.234567890123, MPFR_RNDZ);
  mpfr_set_d(c_main, 2.3456789012345, MPFR_RNDZ);
  
    mpfr_add(temp_var_1, a_main, b_main, MPFR_RNDZ);
    mpfr_mul(d_main, (temp_var_1), c_main, MPFR_RNDZ);
  printf("%.8f,", mpfr_get_d(d_main, MPFR_RNDZ));
  return 0;
}
